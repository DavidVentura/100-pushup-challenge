          ...
          {setStatus.timerActive && !setStatus.isResting && (
            <div className="text-center space-y-2">
              <div className="text-xl font-bold">
                ...
                Set in Progress: {Math.floor((Date.now() - (setStatus.startTime || 0)) / 1000)}s
              </div>
              <div className="flex justify-center space-x-4">
                <Button variant="default" onClick={handleFinishSet}>Finished</Button>
                <Button variant="destructive" onClick={handleFailSet}>Failed</Button>
              </div>
            </div>
          )}
            ...
            <div className="text-center space-y-2">
              ...
              {timeLeft === 0 && (
                <div className="flex justify-center space-x-4">
                  ...
                  <Button variant="default" onClick={() => {handleNextSet(); handleStartSet()}}>
                    Start next set
                  </Button>
                </div>
              )}
